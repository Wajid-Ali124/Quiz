export const data = [
    ...
    {
        title: 'What does the following TypeScript code snippet output?\n\nlet x: number | string;\nx = 10;\nconsole.log(typeof x);\nx = "hello";\nconsole.log(typeof x);\n',
    ...
    {
        title: "Which of the following allows you to specify optional properties in an interface?\n\ninterface Person {\n   name: string;\n   age?: number;\n}\n",
        choices: [
    ...
    {
        title: "How do you create a read-only property in a TypeScript interface?\n\ninterface Person {\n   readonly id: number;\n   name: string;\n}\n",
        choices: [
    ...
    {
        title: 'What is the output of the following TypeScript code snippet using generics?\n\nfunction identity<T>(arg: T): T {\n    return arg;\n}\n\nconsole.log(identity<number>(42));\nconsole.log(identity<string>("TypeScript"));\n',
